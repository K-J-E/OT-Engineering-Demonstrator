...
class SuspensionEvaluationType(StrEnum):
    ENGINEERING_BEHAVIOUR = "ENGINEERING_BEHAVIOUR"
...
class DeterminationContextKind(StrEnum):
    SCENARIO_EXECUTION = "SCENARIO_EXECUTION"
    CONTROLLED_FIXTURE_EXECUTION = "CONTROLLED_FIXTURE_EXECUTION"
    PRESERVED_RECORD_SET = "PRESERVED_RECORD_SET"
    ENGINEERING_REVIEW = "ENGINEERING_REVIEW"
...
class DeterminationOperator(StrEnum):
    SCALAR_EQUAL = "SCALAR_EQUAL"
    NUMERIC_EQUAL = "NUMERIC_EQUAL"
    BOOLEAN_EQUAL = "BOOLEAN_EQUAL"
    CANONICAL_SET_EQUAL = "CANONICAL_SET_EQUAL"
    ORDERED_SEQUENCE_EQUAL = "ORDERED_SEQUENCE_EQUAL"
    PRESENT = "PRESENT"
    ABSENT = "ABSENT"
    IDENTITY_HASH_AGREEMENT = "IDENTITY_HASH_AGREEMENT"
    CANONICAL_RECORD_EQUAL = "CANONICAL_RECORD_EQUAL"
    REVIEW_FINDING_EQUAL = "REVIEW_FINDING_EQUAL"
...
class DeterminationCompletenessStatus(StrEnum):
    INCOMPLETE = "INCOMPLETE"
    COMPLETE = "COMPLETE"


class DeterminationContextStatus(StrEnum):
    DRAFT = "DRAFT"
    FROZEN = "FROZEN"
...
class DeterminationSourceAdapterKind(StrEnum):
    CONFIGURATION_PACKAGE = "CONFIGURATION_PACKAGE"
    SCENARIO_STATE = "SCENARIO_STATE"
    CONTROLLED_FIXTURE = "CONTROLLED_FIXTURE"
    OPERATIONAL_EVENT_HISTORY = "OPERATIONAL_EVENT_HISTORY"
    VALIDATION_INVESTIGATION_HISTORY = "VALIDATION_INVESTIGATION_HISTORY"
    DETERMINISTIC_REPEAT = "DETERMINISTIC_REPEAT"
    EVIDENCE_PACKAGE = "EVIDENCE_PACKAGE"
    NFR_REVIEW = "NFR_REVIEW"
