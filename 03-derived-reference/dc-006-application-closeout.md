---
Status: Release-convergence implementation verified; final Showcase RC review pending
...
- DC-008-applied active-candidate Validation Catalogue v1.2 catalogue SHA-256: `3553ac28856cbe64056fda516ccdc05242960194e956444c01bd11eb7fbd3d1f`.
- DC-008-applied active-candidate Validation Catalogue v1.2 manifest SHA-256: `e1bba6567da17a1074536859a17ff553f3b969ae1c27eefd1265e20bafdbe07f`.
- Exact active authority metadata: `Accepted Validation Plan v1.5 Section 21 / DC-006 + DC-007 + DC-008`.
...
- Superseded pre-DC-008 unaccepted candidate catalogue/manifest SHA-256: `f224a8826f4c02dd0c4bb5c22f3ab7351cd4eb17106b78541aeaf3b1c1d9cbe4` / `ef30f4e17a67dadefce5141edb3335544804bf512e4d76e85f351bc4fa0ee4c9`. It remains candidate history only and is not a historical resolver target.
...
- QA-053 closes the release-critical producer → role → selector → observation paths and preserves truthful incomplete treatment for absent campaign evidence. Required lifecycle roots now exist only when the controlling backend produced the corresponding command result, replay, invalidation, restoration execution, evidence, alarm/event or history record; absent roots resolve to `NOT_EVALUATED`/`INCOMPLETE` with no result. The DC-007 DEF and DC-008 SEP compound selectors have deterministic source-derived treatments with positive, changed-fact and missing-evidence tests. Existing conformance tests cover the exact nine VT-EXP-ALL-001 and four VT-EXP-ROLE-001 methods through genuine scenario evidence, including A4 fresh/stale at 60,001 ms, A2/B2 PERMITTED, A1 REJECTED and A4 NO_CANDIDATE. This is implementation conformance, not a claim that the full 24-test validation campaign has been executed.
...
- Focused DC-006 determination integration tests: **49 passed**.
- Complete backend regression: **205 passed**.
...
- Validation Plan v1.5/System Architecture/Workflow Design/Demonstrator Design: `33d8f46d…86c9b` / `76c768df…db47c` / `aa588610…a479` / `f907d039…ede2`. Superseded accepted Validation Plan v1.4 remains preserved at `0cf0d383…e4f5f`.
...
Final independent re-review closed QA-050 at reviewed tip `4ba232a14b4a5a6a8349fe5bc5eab1631ba5cb47`; QA-051 and QA-052 remain closed at `c7879bd59a745e1f361cdf756c9271b93c79b661`. Under the authorised Showcase V1 Release Convergence Sprint, the bounded QA-053–QA-055 corrections and DC-008 machine application are release-verified on the same branch without changing accepted engineering meaning, algorithms, authoritative documents, dependencies or DC-004/DC-005 semantics. The complete 24-test catalogue campaign remains unexecuted; absent campaign evidence remains explicitly `NOT_EVALUATED`/`INCOMPLETE` and no verdict is manufactured. Further catalogue-wide assurance automation is post-outreach/V2 work.

The next gate is incorporation of the converged PR #12 history, followed by I9 Showcase Packaging and one final independent Showcase RC review.
