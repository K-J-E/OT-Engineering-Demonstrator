...
- Accepted multi-run exploratory validation determination: `DC-004-multi-run-exploratory-validation-determination.md` together with authoritative Validation Plan v1.3 Section 19 and Demonstrator Design v0.5 Section 36. These define the immutable historical-catalogue/test-definition resolver, engineering-expectation versus provenance separation and constituent-owned scenario-time rule. Final independent review accepted the complete PR #10 application boundary at exact tip `eced7c06c27b959cdb29d3aaa9351ca11cb5e258`; QA-041 through QA-049 are closed for this boundary.
- Accepted validation-suspension assurance design and application: `DC-005-controlled-validation-suspension-and-blocked-test-determination.md` together with Requirements Specification v0.4 clarification at `REQ-VAL-007`–`REQ-VAL-009`, Validation Plan v1.3 Section 20, Demonstrator Design v0.5 Section 37, System Architecture v0.4 Section 27 and Workflow Design v0.4 Section 28. The independently accepted machine/application treatment is preserved in the reviewed PR #10 history; this acceptance does not authorise I9.
- Accepted controlled validation-test determination design and authoritative-document application: `DC-006-controlled-validation-test-determination-methods.md` together with Validation Plan v1.3 Section 21, System Architecture v0.4 Section 28, Workflow Design v0.4 Section 29 and Demonstrator Design v0.5 Section 38. Independent re-review accepted the exact technical content at tip `c19451134c36d13d54f2185a3eaa0f20fcce95f0`; DR-01–DR-07 and AA-01–AA-04 are closed. The machine Validation Catalogue and application remain unchanged pending separate authorisation, and I9 remains stopped.
...
Current gate: I8 is accepted after final independent review of tip `111df44a425731dc7f44c437c1d675e5dac85263`. **DC-004 and DC-005 are accepted authoritative design and machine/application baselines. DC-006 design and authoritative-document application are accepted at reviewed technical tip `c19451134c36d13d54f2185a3eaa0f20fcce95f0`; its machine/catalogue application is pending separate authorisation. I9 remains stopped.**
...
2. accepted Validation Plan v1.3 Sections 4, 14, 19 and 20;
3. accepted Demonstrator Design v0.5 Sections 8.7, 9, 19–21, 36 and 37;
4. accepted System Architecture v0.4 Sections 10, 12, 20 and 27;
5. accepted Workflow Design v0.4 Sections 5.2, 14, 19 and 28;
...
## Accepted DC-006 authoritative-document reading path

Before any separately authorised DC-006 machine/catalogue application, read in order:

1. `02-change-control/DC-006-controlled-validation-test-determination-methods.md` in full;
2. accepted Validation Plan v1.3 Section 21 and its exact direct/constituent criteria matrices;
3. accepted System Architecture v0.4 Section 28;
4. accepted Workflow Design v0.4 Section 29;
5. accepted Demonstrator Design v0.5 Section 38;
