...
- Accepted controlled validation-test determination design and authoritative-document application: `DC-006-controlled-validation-test-determination-methods.md` together with Validation Plan v1.3 Section 21, System Architecture v0.4 Section 28, Workflow Design v0.4 Section 29 and Demonstrator Design v0.5 Section 38. Independent re-review accepted the exact technical content at tip `c19451134c36d13d54f2185a3eaa0f20fcce95f0`; DR-01–DR-07 and AA-01–AA-04 are closed. The separately authorised machine/catalogue application is complete on its dedicated branch pending independent review; I9 remains stopped.
