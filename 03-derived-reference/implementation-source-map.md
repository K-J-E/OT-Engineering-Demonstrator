...
- Accepted validation determination and provenance treatment: `DC-006-controlled-validation-test-determination-methods.md`, `DC-007-vt-top-def-current-run-criterion-provenance-clarification.md` and `DC-008-sep-separation-criterion-source-provenance.md`, together with Validation Plan v1.5 Section 21, System Architecture v0.4 Section 28, Workflow Design v0.4 Section 29 and Demonstrator Design v0.5 Section 38. The converged Validation Catalogue v1.2/application history is incorporated at main `e4a934c97c84bcbcf7be9d2b0539aa9c24c52191`; the complete catalogue campaign is not claimed as executed.
